// // components/about/AboutLiquidGlass.tsx
// "use client";
...
//     let time = 0;
//     const colors = ["#FFD60A", "#B1A606", "#FFD60A"];

//     const draw = () => {
//       ctx.clearRect(0, 0, width, height);
//       for (let i = 0; i < 3; i++) {
//         const grad = ctx.createRadialGradient(
//           width * (0.3 + Math.sin(time * 0.2 + i) * 0.1),
//           height * (0.5 + Math.cos(time * 0.3 + i) * 0.1),
//           50,
//           width * (0.4 + Math.sin(time * 0.4 + i) * 0.1),
//           height * (0.6 + Math.cos(time * 0.5 + i) * 0.1),
//           width * 0.6
//         );
//         grad.addColorStop(0, colors[i % colors.length] + "08");
//         grad.addColorStop(0.5, colors[(i+1) % colors.length] + "04");
...
//   return <canvas ref={canvasRef} className="fixed inset-0 -z-10 h-full w-full" style={{ opacity: 0.5 }} />;
// }
