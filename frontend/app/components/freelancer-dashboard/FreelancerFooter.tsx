...
import { FaCalendarCheck, FaCheckCircle, FaHeadset, FaToolbox } from "react-icons/fa";

const footerLinks = [
  { label: "Leads", href: "/freelancer/leads" },
  { label: "Jobs", href: "/freelancer/jobs" },
  { label: "Schedule", href: "/freelancer/schedule" },
  { label: "Billing", href: "/freelancer/billing" },
  { label: "Settings", href: "/freelancer/settings" },
];

const supportItems = [
  { label: "Solo operator", icon: FaToolbox },
  { label: "Fast response", icon: FaCalendarCheck },
  { label: "Client support", icon: FaHeadset },
];
    ...
    <footer className="border-t border-gray-200 bg-white">
      <div className="px-4 py-6 sm:px-6 lg:px-8">
        <div className="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
          <div className="flex min-w-0 items-center gap-3">
            ...
            <div className="min-w-0">
              <p className="text-sm font-bold text-gray-900">Plumber Finder Freelancer Dashboard</p>
              <p className="text-xs text-gray-500">
                Manage leads, jobs, availability, billing, and client feedback.
              </p>
            </div>
          </div>
        ...
        <div className="mt-5 flex flex-col gap-3 border-t border-gray-100 pt-4 text-xs text-gray-500 sm:flex-row sm:items-center sm:justify-between">
          ...
          <nav className="flex flex-wrap gap-x-4 gap-y-2" aria-label="Freelancer dashboard footer links">
